...
async def explorar_armas_guiado():
    ...
    async with async_playwright() as p:
        ...
        log("Tentando localizar o card 'Pesquisar Armas na Base do CAD'...")
        ...
        log("HTML salvo em debug_cad_armas_frame.html. O navegador permanecerá aberto.")    
        await asyncio.sleep(120)
        await browser.close()

if __name__ == "__main__":
    asyncio.run(explorar_armas_guiado())
